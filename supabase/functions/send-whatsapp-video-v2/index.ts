...
serve(async (req) => {
  ...
  try {
    ...
    console.log('📤 [send-whatsapp-video-v2] Sending video for message:', messageId);
    ...
    console.log('✅ Video sent successfully:', whatsappMessageId);
    ...
    console.error('❌ Error in send-whatsapp-video-v2:', error);
    return new Response(JSON.stringify({ 
      success: false, 
      error: error.message 
    }), {
